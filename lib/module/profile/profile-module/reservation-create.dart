...
class _ReservationCreateState extends State<ReservationCreate> {
  ...
  @override
  void initState() {
    // _nameAndSurname.text= member$.value.first.profile.fullname != null ?
    super.initState();
  }
          ...
          child: Column(
            children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                SizedBox(width: W / 60),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text("Phone Number".tr()), Text(phone, style: kProxima17)]),
              ]),
              const Divider(),
              Padding(
                padding: EdgeInsets.only(bottom: MediaQuery.of(context).padding.bottom),
